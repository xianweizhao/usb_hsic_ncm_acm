...
struct link_pm_data {
	...
	bool link_pm_active;      /* when use pm_runtime_suspend set it true */
	bool c8320_runtime_resume;
...
//	struct delayed_work link_event; /* CYIT CP not need link event */
